export default {
  ...
  helpInfo: {
    ...
    deleteChannel: 'Delete edited channel',
    editChannel: 'Edit Channel',
    expandChannel: 'Expand Channel',
    increaseBPM: 'Increase BPM value',
    minimizeChannel: 'Minimize Channel',
    mute: 'Mute sound',
    muteChannel: 'Mute Channel',
    play: 'Start playing',
    selectFileType: 'Choose Channel Type - File',
    selectNoiseType: 'Choose Channel Type - Noise',
    selectOscType: 'Choose Channel Type - Oscillator',
    selectRouteType: 'Choose Channel Type - Route',
    soloOff: 'Solo Off',
    soloOn: 'Solo On',
    stop: 'Stop playing',
    timeRulerHide: 'Hide time ruler',
    timeRulerShow: 'Show time ruler',
    unmute: 'Unmute sound',
